...
[`@aws-sdk/client-eks`](https://www.npmjs.com/package/@aws-sdk/client-eks/v/3.1073.0).
...
- @aws-sdk/client-eks - [https://cloud-sdk-builds.github.io/?sdk=client-eks](https://cloud-sdk-builds.github.io/?sdk=client-eks)
- @aws-sdk/client-eks v3.1073.0 - [https://cloud-sdk-builds.github.io/?sdk=client-eks&version=3.1073.0](https://cloud-sdk-builds.github.io/?sdk=client-eks&version=3.1073.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks@3.1073.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sjFrmA77Expzo2kQLBZSP/b0zuN9HFog2Aiq/KNAroD7XZzUzWIMeLgQ637Eui33
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-eks": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks@3.1073.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-eks@3.1073.0/index.min.mjs": "sha384-sjFrmA77Expzo2kQLBZSP/b0zuN9HFog2Aiq/KNAroD7XZzUzWIMeLgQ637Eui33"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-eks";
...
```
https://github.com/cloud-sdk-builds/client-eks/blob/refs/tags/3.1073.0/LICENSE
```
